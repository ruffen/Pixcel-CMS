...
************************************************************************************************************/	
	...
	function JSDragDropTree()
	{
		...
		this.imageFolder = '/static/images/icons/16/';
		this.folderImage = 'users.png';
		this.secondImage = 'user.png';
		...
		this.floatingContainer.id = 'file_tree_float';
	    ...
	    initTree: function () {
	        ...
	        for (var no = 0; no < menuItems.length; no++) {
	            ...
	            if (menuItems[no].className) {
	                ...
	                folderImg.src = this.imageFolder + this.secondImage;
	            }
